<template>
    ...
    <q-page v-if="!loading" class="q-px-md animate__animated animate__fadeIn animate__slower">
      <section>
      ...
      <p class="q-pt-xs animate__animated animate__flipInY animate__slower text-bold text-center font-decorative-2 text-black" style="font-size: 1.1rem;filter:drop-shadow(0px 0px .2rem white)">Crie, Compartilhe e Descubra<br>Repertórios Personalizados!</p>
